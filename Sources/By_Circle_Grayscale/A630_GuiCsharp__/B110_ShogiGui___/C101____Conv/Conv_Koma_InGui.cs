...
namespace Grayscale.A630_GuiCsharp__.B110_ShogiGui___.C101____Conv
{
    public abstract class Conv_Koma_InGui
    {
        ...
        /// <returns></returns>
        public static List<Shape_BtnKoma> HKomasToBtns(List<int> hKomas, ServersideShogibanGui_Csharp shogiGui)
        {
        ...
        public static Shape_BtnKoma FingerToKomaBtn(Finger koma, ServersideShogibanGui_Csharp shogiGui)
        {
