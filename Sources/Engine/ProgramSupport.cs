namespace Grayscale.kifuwarakei.Engine
{
    ...
    {
        public Mojiretu Syuturyoku { get; private set; }
...
*/
            ...
            this.Syuturyoku = Util_Machine.Syuturyoku;

            // （手順３）アプリケーション開始時設定　を終えた後に　これを呼び出すこと☆（＾～＾）！
            Face_Kifuwarabe.OnApplicationReadied(Option_Application.Kyokumen, this.Syuturyoku);
