...
public abstract class Util_TumeShogi
{
    ...
    {
        // FIXME: 終わったら元に戻したいが☆（＾～＾）
        Option_Application.Optionlist.PNChar[(int)Phase.Black] = SasiteCharacter.TansakuNomi;
        Option_Application.Optionlist.PNChar[(int)Phase.White] = SasiteCharacter.TansakuNomi;
